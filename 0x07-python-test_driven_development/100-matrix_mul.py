...
def matrix_mul(m_a, m_b):
    ...
    Raises:
    TypeError: If m_a or m_b is not a list, not a list of lists, not rectangular, or contains non-integer/float elements.
    ...
    # Check if m_a and m_b are rectangular (all rows have the same size)
